...
import com.len.kindle.service.tableinfo.UserInfoService;
...
public class UserInfoController {
    ...
    public String list(HttpServletRequest request, HttpServletResponse response,
        ...
        Page<UserInfo> userInfoPage = userInfoService.findAll(condition, pageable);

        //页面数据存储
        request.setAttribute(Constant.PAGE_KEY, userInfoPage);
        request.setAttribute(Constant.CONDITION_KEY, condition);

        return PageEnum.PAGE_TABLEINFO_USERINFOLIST.getPage();
    }
}
