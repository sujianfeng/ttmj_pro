...
import com.len.kindle.service.tableinfo.HeaderInfoService;
 ...
 */
@Controller
@RequestMapping("/server/headerinfo")
public class HeaderInfoController {
    ...
    public String list(HttpServletRequest request, HttpServletResponse response,
        ...
        Page<HeaderInfo> headerInfoPage = headerInfoService.findAll(condition, pageable);

        //页面数据存储
        request.setAttribute(Constant.PAGE_KEY, headerInfoPage);
        request.setAttribute(Constant.CONDITION_KEY, condition);

        return PageEnum.PAGE_TABLEINFO_HEADINFOLIST.getPage();
    }
}
