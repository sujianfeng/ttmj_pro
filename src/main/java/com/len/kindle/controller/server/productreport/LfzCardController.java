...
@Slf4j
@Controller
@RequestMapping("/server/pr/lfzcard")
public class LfzCardController {
    ...
    public String list(HttpServletRequest request, HttpServletResponse response,
        ...
        List<CardVo> cardVoList = productReportService.getCardVoList(condition);

        //页面数据存储
        request.setAttribute(Constant.DATA_SUMMARY_LIST_KEY, cardVoList);
        request.setAttribute(Constant.CONDITION_KEY, condition);
        return PageEnum.PAGE_PR_LFZCARD.getPage();
    }
