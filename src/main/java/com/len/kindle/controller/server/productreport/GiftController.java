...
public class GiftController {
    ...
    public String list(HttpServletRequest request, HttpServletResponse response,
        ...
        List<ChargeVo> chargeVoList = productReportService.getChargeVoList(condition);

        //页面数据存储
        request.setAttribute(Constant.DATA_SUMMARY_LIST_KEY, chargeVoList);
        request.setAttribute(Constant.CONDITION_KEY, condition);
        return PageEnum.PAGE_PR_GIFT.getPage();
    }
