...
import com.len.kindle.service.tableinfo.PropertyRecordService;
 ...
 */
@Controller
@RequestMapping("/server/propertyrecord")
public class PropertyRecordController {
    ...
    public String list(HttpServletRequest request, HttpServletResponse response,
        ...
        Page<PropertyRecord> propertyRecordPage = propertyRecordService.findAll(condition, pageable);

        //页面数据存储
        request.setAttribute(Constant.PAGE_KEY, propertyRecordPage);
        request.setAttribute(Constant.CONDITION_KEY, condition);

        return PageEnum.PAGE_TABLEINFO_PROPERTYRECORDLIST.getPage();
    }
}
